...
function Dashboard() {
  ...
  function handleDisplayChange(event) {
    ...
    return (
      <div className="flex flex-col lg:flex-row item-center  bg-stone-100  h-full">
        <div className="flex-col w-8/12 h-full">
          ...
          {displayChange ? (
            <div className="flex-col pl-5 w-full h-[93%]">
              <div className="items-center justify-center bg-white flex w-full rounded-xl shadow-md h-[97%] ">
                <DataProject />
              </div>
            </div>
          ) : (
