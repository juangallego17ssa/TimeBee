         ...
         <div className="flex-col w-4/12 h-full p-5">
           <div className="bg-stone-100 h-full w-full py-4 px-9 rounded-3xl">
             ...
             <div className="mt-3 flex">
               <div className="flex justify-center items-center cursor-pointer w-1/12 semi-bold text-sm text-sky-600">&lt;&lt;</div>
               <div className="flex justify-center items-center w-10/12 semi-bold text-xs text-sky-600">Week 16</div>
               <div className="flex justify-center items-center cursor-pointer w-1/12 semi-bold text-sm text-sky-600">&gt;&gt;</div>
             </div>
